...
class Maze(GridWorld):
    ...
    def __init__(self, name, layout, wall_reset=False, visualizer=None, scale=5, dt=0.05, force_scale=50.):
        super(Maze, self).__init__(name, layout, wall_reset=wall_reset, visualizer=visualizer, scale=scale)
