...
from smartstart.algorithms.tiles import *
...
class TileCodingFeature(Feature):

    def __init__(self, num_tiles, size=2048):
        self.size = size
        self.iht = IHT(size)
    ...
    def get(self, obs):
        ...
        indices = tiles(self.iht, self.num_tiles, list(obs))
