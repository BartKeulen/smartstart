...
from utilities.gcloud import run_on_gcloud
...
parser.add_argument('--instance_type', type=str, default='n1-highcpu-8', help='Google Compute Engine instance type, available types can be found here: https://cloud.google.com/compute/pricing')
